...
enum {
  ...
  ET_RtnPrivateSeqNo = ET_BASE + 5,
  ET_RspUserLogin = ET_BASE + 6,
  ET_RspUserLogout = ET_BASE + 7,
  ET_RspUserPasswordUpdate = ET_BASE + 8,
  ET_RspTradingAccountPasswordUpdate = ET_BASE + 9,
  ET_RspUserAuthMethod = ET_BASE + 10,
  ET_RspGenUserCaptcha = ET_BASE + 11,
  ET_RspGenUserText = ET_BASE + 12,
  ET_RspOrderInsert = ET_BASE + 13,
  ET_RspParkedOrderInsert = ET_BASE + 14,
  ET_RspParkedOrderAction = ET_BASE + 15,
  ET_RspOrderAction = ET_BASE + 16,
  ET_RspQryMaxOrderVolume = ET_BASE + 17,
  ET_RspSettlementInfoConfirm = ET_BASE + 18,
  ET_RspRemoveParkedOrder = ET_BASE + 19,
  ET_RspRemoveParkedOrderAction = ET_BASE + 20,
  ET_RspExecOrderInsert = ET_BASE + 21,
  ET_RspExecOrderAction = ET_BASE + 22,
  ET_RspForQuoteInsert = ET_BASE + 23,
  ET_RspQuoteInsert = ET_BASE + 24,
  ET_RspQuoteAction = ET_BASE + 25,
  ET_RspBatchOrderAction = ET_BASE + 26,
  ET_RspOptionSelfCloseInsert = ET_BASE + 27,
  ET_RspOptionSelfCloseAction = ET_BASE + 28,
  ET_RspCombActionInsert = ET_BASE + 29,
  ET_RspQryOrder = ET_BASE + 30,
  ET_RspQryTrade = ET_BASE + 31,
  ET_RspQryInvestorPosition = ET_BASE + 32,
  ET_RspQryTradingAccount = ET_BASE + 33,
  ET_RspQryInvestor = ET_BASE + 34,
  ET_RspQryTradingCode = ET_BASE + 35,
  ET_RspQryInstrumentMarginRate = ET_BASE + 36,
  ET_RspQryInstrumentCommissionRate = ET_BASE + 37,
  ET_RspQryUserSession = ET_BASE + 38,
  ET_RspQryExchange = ET_BASE + 39,
  ET_RspQryProduct = ET_BASE + 40,
  ET_RspQryInstrument = ET_BASE + 41,
  ET_RspQryDepthMarketData = ET_BASE + 42,
  ET_RspQryTraderOffer = ET_BASE + 43,
  ET_RspQrySettlementInfo = ET_BASE + 44,
  ET_RspQryTransferBank = ET_BASE + 45,
  ET_RspQryInvestorPositionDetail = ET_BASE + 46,
  ET_RspQryNotice = ET_BASE + 47,
  ET_RspQrySettlementInfoConfirm = ET_BASE + 48,
  ET_RspQryInvestorPositionCombineDetail = ET_BASE + 49,
  ET_RspQryCFMMCTradingAccountKey = ET_BASE + 50,
  ET_RspQryEWarrantOffset = ET_BASE + 51,
  ET_RspQryInvestorProductGroupMargin = ET_BASE + 52,
  ET_RspQryExchangeMarginRate = ET_BASE + 53,
  ET_RspQryExchangeMarginRateAdjust = ET_BASE + 54,
  ET_RspQryExchangeRate = ET_BASE + 55,
  ET_RspQrySecAgentACIDMap = ET_BASE + 56,
  ET_RspQryProductExchRate = ET_BASE + 57,
  ET_RspQryProductGroup = ET_BASE + 58,
  ET_RspQryMMInstrumentCommissionRate = ET_BASE + 59,
  ET_RspQryMMOptionInstrCommRate = ET_BASE + 60,
  ET_RspQryInstrumentOrderCommRate = ET_BASE + 61,
  ET_RspQrySecAgentTradingAccount = ET_BASE + 62,
  ET_RspQrySecAgentCheckMode = ET_BASE + 63,
  ET_RspQrySecAgentTradeInfo = ET_BASE + 64,
  ET_RspQryOptionInstrTradeCost = ET_BASE + 65,
  ET_RspQryOptionInstrCommRate = ET_BASE + 66,
  ET_RspQryExecOrder = ET_BASE + 67,
  ET_RspQryForQuote = ET_BASE + 68,
  ET_RspQryQuote = ET_BASE + 69,
  ET_RspQryOptionSelfClose = ET_BASE + 70,
  ET_RspQryInvestUnit = ET_BASE + 71,
  ET_RspQryCombInstrumentGuard = ET_BASE + 72,
  ET_RspQryCombAction = ET_BASE + 73,
  ET_RspQryTransferSerial = ET_BASE + 74,
  ET_RspQryAccountregister = ET_BASE + 75,
  ET_RspError = ET_BASE + 76,
  ET_RtnOrder = ET_BASE + 77,
  ET_RtnTrade = ET_BASE + 78,
  ET_ErrRtnOrderInsert = ET_BASE + 79,
  ET_ErrRtnOrderAction = ET_BASE + 80,
  ET_RtnInstrumentStatus = ET_BASE + 81,
  ET_RtnBulletin = ET_BASE + 82,
  ET_RtnTradingNotice = ET_BASE + 83,
  ET_RtnErrorConditionalOrder = ET_BASE + 84,
  ET_RtnExecOrder = ET_BASE + 85,
  ET_ErrRtnExecOrderInsert = ET_BASE + 86,
  ET_ErrRtnExecOrderAction = ET_BASE + 87,
  ET_ErrRtnForQuoteInsert = ET_BASE + 88,
  ET_RtnQuote = ET_BASE + 89,
  ET_ErrRtnQuoteInsert = ET_BASE + 90,
  ET_ErrRtnQuoteAction = ET_BASE + 91,
  ET_RtnForQuoteRsp = ET_BASE + 92,
  ET_RtnCFMMCTradingAccountToken = ET_BASE + 93,
  ET_ErrRtnBatchOrderAction = ET_BASE + 94,
  ET_RtnOptionSelfClose = ET_BASE + 95,
  ET_ErrRtnOptionSelfCloseInsert = ET_BASE + 96,
  ET_ErrRtnOptionSelfCloseAction = ET_BASE + 97,
  ET_RtnCombAction = ET_BASE + 98,
  ET_ErrRtnCombActionInsert = ET_BASE + 99,
  ET_RspQryContractBank = ET_BASE + 100,
  ET_RspQryParkedOrder = ET_BASE + 101,
  ET_RspQryParkedOrderAction = ET_BASE + 102,
  ET_RspQryTradingNotice = ET_BASE + 103,
  ET_RspQryBrokerTradingParams = ET_BASE + 104,
  ET_RspQryBrokerTradingAlgos = ET_BASE + 105,
  ET_RspQueryCFMMCTradingAccountToken = ET_BASE + 106,
  ET_RtnFromBankToFutureByBank = ET_BASE + 107,
  ET_RtnFromFutureToBankByBank = ET_BASE + 108,
  ET_RtnRepealFromBankToFutureByBank = ET_BASE + 109,
  ET_RtnRepealFromFutureToBankByBank = ET_BASE + 110,
  ET_RtnFromBankToFutureByFuture = ET_BASE + 111,
  ET_RtnFromFutureToBankByFuture = ET_BASE + 112,
  ET_RtnRepealFromBankToFutureByFutureManual = ET_BASE + 113,
  ET_RtnRepealFromFutureToBankByFutureManual = ET_BASE + 114,
  ET_RtnQueryBankBalanceByFuture = ET_BASE + 115,
  ET_ErrRtnBankToFutureByFuture = ET_BASE + 116,
  ET_ErrRtnFutureToBankByFuture = ET_BASE + 117,
  ET_ErrRtnRepealBankToFutureByFutureManual = ET_BASE + 118,
  ET_ErrRtnRepealFutureToBankByFutureManual = ET_BASE + 119,
  ET_ErrRtnQueryBankBalanceByFuture = ET_BASE + 120,
  ET_RtnRepealFromBankToFutureByFuture = ET_BASE + 121,
  ET_RtnRepealFromFutureToBankByFuture = ET_BASE + 122,
  ET_RspFromBankToFutureByFuture = ET_BASE + 123,
  ET_RspFromFutureToBankByFuture = ET_BASE + 124,
  ET_RspQueryBankAccountMoneyByFuture = ET_BASE + 125,
  ET_RtnOpenAccountByBank = ET_BASE + 126,
  ET_RtnCancelAccountByBank = ET_BASE + 127,
  ET_RtnChangeAccountByBank = ET_BASE + 128,
  ET_RspQryClassifiedInstrument = ET_BASE + 129,
  ET_RspQryCombPromotionParam = ET_BASE + 130,
  ET_RspQryRiskSettleInvstPosition = ET_BASE + 131,
  ET_RspQryRiskSettleProductStatus = ET_BASE + 132,
  ET_RspQrySPBMFutureParameter = ET_BASE + 133,
  ET_RspQrySPBMOptionParameter = ET_BASE + 134,
  ET_RspQrySPBMIntraParameter = ET_BASE + 135,
  ET_RspQrySPBMInterParameter = ET_BASE + 136,
  ET_RspQrySPBMPortfDefinition = ET_BASE + 137,
  ET_RspQrySPBMInvestorPortfDef = ET_BASE + 138,
  ET_RspQryInvestorPortfMarginRatio = ET_BASE + 139,
  ET_RspQryInvestorProdSPBMDetail = ET_BASE + 140,
  ET_RspQryInvestorCommoditySPMMMargin = ET_BASE + 141,
  ET_RspQryInvestorCommodityGroupSPMMMargin = ET_BASE + 142,
  ET_RspQrySPMMInstParam = ET_BASE + 143,
  ET_RspQrySPMMProductParam = ET_BASE + 144,
  ET_RspQrySPBMAddOnInterParameter = ET_BASE + 145,
  ET_RspQryRCAMSCombProductInfo = ET_BASE + 146,
  ET_RspQryRCAMSInstrParameter = ET_BASE + 147,
  ET_RspQryRCAMSIntraParameter = ET_BASE + 148,
  ET_RspQryRCAMSInterParameter = ET_BASE + 149,
  ET_RspQryRCAMSShortOptAdjustParam = ET_BASE + 150,
  ET_RspQryRCAMSInvestorCombPosition = ET_BASE + 151,
  ET_RspQryInvestorProdRCAMSMargin = ET_BASE + 152,
  ET_RspQryRULEInstrParameter = ET_BASE + 153,
  ET_RspQryRULEIntraParameter = ET_BASE + 154,
  ET_RspQryRULEInterParameter = ET_BASE + 155,
  ET_RspQryInvestorProdRULEMargin = ET_BASE + 156,
  ET_RspQryInvestorPortfSetting = ET_BASE + 157,
  ET_RspQryInvestorInfoCommRec = ET_BASE + 158,
  ET_RspQryCombLeg = ET_BASE + 159,
  ET_RspOffsetSetting = ET_BASE + 160,
  ET_RspCancelOffsetSetting = ET_BASE + 161,
  ET_RtnOffsetSetting = ET_BASE + 162,
  ET_ErrRtnOffsetSetting = ET_BASE + 163,
  ET_ErrRtnCancelOffsetSetting = ET_BASE + 164,
  ET_RspQryOffsetSetting = ET_BASE + 165,
  ET_RspGenSMSCode = ET_BASE + 166,
  ET_RspSpdApply = ET_BASE + 167,
  ET_RspSpdApplyAction = ET_BASE + 168,
  ET_RspQrySpdApply = ET_BASE + 169,
  ET_RtnSpdApply = ET_BASE + 170,
  ET_ErrRtnSpdApply = ET_BASE + 171,
  ET_ErrRtnSpdApplyAction = ET_BASE + 172,
  ET_RspHedgeCfm = ET_BASE + 173,
  ET_RspHedgeCfmAction = ET_BASE + 174,
  ET_RspQryHedgeCfm = ET_BASE + 175,
  ET_RtnHedgeCfm = ET_BASE + 176,
  ET_ErrRtnHedgeCfm = ET_BASE + 177,
  ET_ErrRtnHedgeCfmAction = ET_BASE + 178,
};
...
public:
  ...
  void OnRtnPrivateSeqNo(int arg) override;
  ...
  void OnRspQryUserSession(CThostFtdcUserSessionField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  ...
  void OnRspQryInvestorPortfSetting(CThostFtdcInvestorPortfSettingField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspQryInvestorInfoCommRec(CThostFtdcInvestorInfoCommRecField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspQryCombLeg(CThostFtdcCombLegField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspOffsetSetting(CThostFtdcInputOffsetSettingField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspCancelOffsetSetting(CThostFtdcInputOffsetSettingField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRtnOffsetSetting(CThostFtdcOffsetSettingField *p) override;
  void OnErrRtnOffsetSetting(CThostFtdcInputOffsetSettingField *p, CThostFtdcRspInfoField *e) override;
  void OnErrRtnCancelOffsetSetting(CThostFtdcCancelOffsetSettingField *p, CThostFtdcRspInfoField *e) override;
  void OnRspQryOffsetSetting(CThostFtdcOffsetSettingField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspGenSMSCode(CThostFtdcRspGenSMSCodeField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspSpdApply(CThostFtdcInputSpdApplyField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspSpdApplyAction(CThostFtdcInputSpdApplyActionField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspQrySpdApply(CThostFtdcSpdApplyField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRtnSpdApply(CThostFtdcSpdApplyField *p) override;
  void OnErrRtnSpdApply(CThostFtdcInputSpdApplyField *p, CThostFtdcRspInfoField *e) override;
  void OnErrRtnSpdApplyAction(CThostFtdcSpdApplyActionField *p, CThostFtdcRspInfoField *e) override;
  void OnRspHedgeCfm(CThostFtdcInputHedgeCfmField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspHedgeCfmAction(CThostFtdcInputHedgeCfmActionField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRspQryHedgeCfm(CThostFtdcHedgeCfmField *p, CThostFtdcRspInfoField *e, int id, bool last) override;
  void OnRtnHedgeCfm(CThostFtdcHedgeCfmField *p) override;
  void OnErrRtnHedgeCfm(CThostFtdcInputHedgeCfmField *p, CThostFtdcRspInfoField *e) override;
  void OnErrRtnHedgeCfmAction(CThostFtdcHedgeCfmActionField *p, CThostFtdcRspInfoField *e) override;
